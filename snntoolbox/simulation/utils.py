...
class AbstractSNN:
    ...
    def __init__(self, config, queue=None):
        ...
        self.flatten_shapes = []
        self.top1err_t = np.zeros(self._num_timesteps,dtype=float)#add
        self.cnn_acc=None#add
    @property
    @abstractmethod
    ...
    def run(self, x_test=None, y_test=None, dataflow=None, **kwargs):
        ...
        for batch_idx in range(num_batches):
            ...
            self.top1err_t += np.mean(self.top1err_b_t, 0) * 100 #add
            ...
            self.cnn_acc = (1 - self.top1err_ann) *100  # add
        ...
        top1err_t = 100 - (self.top1err_t / num_batches)
        with open('convergence.pkl',"wb") as f:
            pickle.dump(top1err_t,f)
        snn_plt.plot_convergence(self.cnn_acc,top1err_t,self._duration, self._dt, log_dir)
